...
bot_log=int(os.getenv('PROBLEM_LOG'))
...
class SubjectView(discord.ui.View):
    ...
    async def select_callback(self,interaction,select):
        ...
        await interaction.guild.get_channel(bot_log).send(content=self.today, embed=embed)
...
class BOJ(commands.Cog):
    def __init__(self, bot):
        ...
        self.bot_log=int(os.getenv('PROBLEM_LOG'))
        ...
        try:
            ...
            if args==('문제줘',):
                ...
                if messages[0].content==today:
                    ...
                    await ctx.reply(view=SubjectView(today=today))
                return
